...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private JwtTokenUtiles jwtTokenUtiles;

    @Autowired
    public void setJwtTokenUtiles(JwtTokenUtiles jwtTokenUtiles) {
        this.jwtTokenUtiles = jwtTokenUtiles;
    }
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain chain) throws ServletException, IOException {
        ...
        if (requestTokenHeader != null && requestTokenHeader.startsWith("Bearer ")) {
            ...
            try {
                username = jwtTokenUtiles.getUsernameFromToken(jwtToken);
        ...
        if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
            ...
            // authentication
            if (jwtTokenUtiles.validateToken(jwtToken, userDetails)) {
